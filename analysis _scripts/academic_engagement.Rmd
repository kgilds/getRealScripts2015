...
Teacher Survey
Question: She completes the homework given to her.

```{r fig.height=2, fig.width=15}
post_teacher <- dbReadTable(getReal_2016db, "post_teacher")

colnames(post_teacher)[15] <- "hmwrk_super"
...
post_teacher_tbl$hmwrk_super <- factor(post_teacher_tbl$hmwrk_super, levels=c("Strongly Disagree", "Disagree", "Slightly Disagree", "Neither Agree/Disagree", "Slightly Agree", "Agree", "Strongly Agree"),ordered = TRUE)
...
```{r fig.height=7, fig.width=14, fig.path='Figs/', dev.args='cario-png'}
...
plot(post_teacher_tbl, type="heat") + ggtitle("Question: She completes the homework given to her") + theme_dark ()
