...
Question 5: She works on her homework at home without supervision N=465

```{r load_parent_survey, echo=FALSE}
...
```{r "q5_parent", fig.height=5, fig.width=14, fig.path='Figs/', dev.args='cario-png', echo=FALSE}
...
```{r "liker_q6", fig.height=5, fig.width=14, fig.path='Figs/', dev.args='cario-png', echo=FALSE}
...
```{r  "load_teacher", fig.height=2, fig.width=15, echo=FALSE}
...
```{r "teacher_plots",fig.height=5, fig.width=14, fig.path='Figs/', dev.args='cario-png', echo=FALSE}
