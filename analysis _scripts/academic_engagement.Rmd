...
```{r council_filter_ae, echo=FALSE}
...
pre_ae_histq <- qplot(ae_2016$Pre, geom="histogram", main= "Pre Survey", bins=50, xlab="Outcome Scores", ylim=c(0,20) ) + geom_vline(xintercept = 4.5, col="red") 


post_ae_histq <-qplot(ae_2016$Post, geom="histogram", main= "Post Survey", bins=25, xlab="Outcome Scores", ylim=c(0,20)) + geom_vline(xintercept = 4.5, col="red")
...
```{r ae_bar, echo=FALSE}
ae_bar_pre <-qplot(ae_2016$Pre >=4.5, geom="bar", ylim=c(0, 100), main="Pre survey Results", xlab="Achievment at High Level")

ae_bar_post <-qplot(ae_2016$Post >=4.45, geom ="bar", ylim=c(0,100), main="Post Survey Results", xlab="Achievment at High Level")
