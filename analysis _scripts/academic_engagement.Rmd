...
```{r fig.width=15}
increase_test <- filter(ae_all, Pre !=6.0 & Post != 6.0)
...
The number and percent of students achieeving the health relationship outcome at a high level or increased score is  **`r ae_match("M3")`**,


and the percent of students achieving at a high level is **`r ae_achieved("M3")`**.  
...
```{r}
pre_ae_histq <- qplot(ae_2016$Pre, geom="histogram", main= "Pre Survey", bins=40, xlab="Outcome Scores", bins=40) + geom_vline(xintercept = 4.5, col="red") 


post_ae_histq <-qplot(ae_2016$Post, geom="histogram", main= "Post Survey", bins=40, xlab="Outcome Scores", ylim=c(0,40)) + geom_vline(xintercept = 4.5, col="red")
