...
```{r}
pre_ae_histq <- qplot(ae_2016$Pre, geom="histogram", main= "Pre Survey", bins=50, xlab="Outcome Scores", bins=40) + geom_vline(xintercept = 4.5, col="red") 


post_ae_histq <-qplot(ae_2016$Post, geom="histogram", main= "Post Survey", bins=50, xlab="Outcome Scores", ylim=c(0,40)) + geom_vline(xintercept = 4.5, col="red")
...
```{r}
cohen.d(ae_2016$Post, ae_2016$Pre, paired=TRUE)
