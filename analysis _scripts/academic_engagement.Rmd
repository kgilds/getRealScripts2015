...
ae_increase_df <- filter(ae_all, Post < 4.5)
...
mean(increase_test$ae.diff)

plot(increase_test$ae.diff)
abline(h=0, col='red')
...
The number and percent of students achieeving the health relationship outcome at a high level or increased score is  **`r ae_match("M3")`**,and the percent of students achieving at a high level is **`r ae_achieved("M3")`**.  
