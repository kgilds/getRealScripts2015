...
```{r council_filter_attendance, echo=FALSE}
...
1. The number of studens who decreased their absences from basline to the final grading period is **`r nrow(decrease_abs)`**
