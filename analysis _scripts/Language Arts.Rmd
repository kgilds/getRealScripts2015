...
3. The percent of students who had a failing grade at baseline and finished with a passing final grade is **`r lang_increase ()`**





The mean difference between baseline grades and final grade **`r pander(lang_gpa_diff)`**. 
...
### Grade Change Plot from baseline to fina grading period: 
The changes in grades from baseline to final grading period is represented below. The vertical axis represents baseline grades and the bottom axis the change from the baseline. Thus ideally we want to see circles moving to right. Note that,students with an A in Q1 can decrease but not increase. 
