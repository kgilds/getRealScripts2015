...
lang_increase <- function() {
    lang_increase_dat <- filter(langarts2016, baseline <= 1)
...
The number of students that could be matched from Quarter 1 to Qua is **`r nrow(langarts2016)`**, and the percent of students that increased their grade or maintained a C  is **`r lang_success ()`**.
