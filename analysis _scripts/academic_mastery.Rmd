...
```{r council_filter_am, echo=FALSE}
...
The number of pre and post survey that could be matched is **`r nrow(am_all)`**, and the percent of students with a successful outcome is **`r am_match("M3")`**
...
pre_am_histq <- qplot(am_2016$Pre, geom="histogram", main= "Pre Survey", bins=50, xlab="Outcome Scores", ylim=c(0,20)) + geom_vline(xintercept = 4.8, col="red") 


post_am_histq <-qplot(am_2016$Post, geom="histogram", main= "Post Survey", bins=50, xlab="Outcome Scores", ylim=c(0,20)) + geom_vline(xintercept = 4.8, col="red")
...
```{r am_bar,echo=FALSE}
am_bar_pre <-qplot(am_2016$Pre >=4.8, geom="bar", ylim=c(0, 100), main="Pre survey Results", xlab="Achievment at High Level")

am_bar_post <-qplot(am_2016$Post >=4.8, geom ="bar", ylim=c(0,100), main="Post Survey Results", xlab="Achievment at High Level")
