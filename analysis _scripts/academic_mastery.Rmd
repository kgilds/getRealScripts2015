...
```{r}
pre_am_histq <- qplot(am_2016$Pre, geom="histogram", main= "Pre Survey", bins=50, xlab="Outcome Scores", bins=40) + geom_vline(xintercept = 4.8, col="red") 


post_am_histq <-qplot(am_2016$Post, geom="histogram", main= "Post Survey", bins=50, xlab="Outcome Scores", ylim=c(0,40)) + geom_vline(xintercept = 4.8, col="red")
