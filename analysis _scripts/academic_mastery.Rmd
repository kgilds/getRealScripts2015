...
```{r pre_survey, fig.height=5, fig.width=10, echo=FALSE}
...
Parent Pre Survey
```{r pre_parent_heat, fig.height=5, fig.width=14, fig.path='Figs/', dev.args='cario-png', echo=FALSE }
likert.heat.plot(pre_parent_tbl) + ggtitle("Pre Parent Survey Question 1 & Question 3") + theme_dark ()

```


```{r pre_post_parent, echo=FALSE}
...
Post Survey
```{ r "post_parent_heat",  fig.height=5, fig.width=14, fig.path='Figs/', dev.args='cario-png', echo=FALSE }
