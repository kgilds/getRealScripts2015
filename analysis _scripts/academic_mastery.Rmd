...
```{r 2014_test, echo=FALSE, eval=FALSE}
...
```{r load_post_teacher, echo=FALSE}
...
```{r heat_post_teacher, fig.height=5, fig.width=14, fig.path='Figs/', dev.args='cario-png', echo=FALSE}
