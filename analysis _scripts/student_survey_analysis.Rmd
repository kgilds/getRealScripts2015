...
The number of students surveys that could be matched from last year is `r nrow(post_merge)`and their average pre score was `r round(mean(post_merge$hr.avg.y,2))`
