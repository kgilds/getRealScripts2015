...
The number of students that could be matched from last year is **`r nrow(reading_q4q2)`**, and the current reading gpa for students who particpated last year is **`r (reading_gpa_m)`**. The percent of studuents of who increased their grade or maintained their grade is **`r read_success_m()`**,and the average difference between Q4 2015 and Q2 is **`r (reading_mean_m)`**. 
