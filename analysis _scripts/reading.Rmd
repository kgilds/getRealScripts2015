...
The changes in grades from Q1 to Q2 is represented below. The vertical axis represents Q1 grades and the bottom axis the change from Q1. Thus ideally we want to see circles moving to right. However,students with an A in Q1 can decrease but not increase. 
...
The number of students that could be matched from last year is **`r nrow(reading_q4q2)`**, and the current reading gpa for students who particpated last year is **`r mean(reading_q4q2$reading_pts2)`**. The percent of studuents of who increased their grade or maintained their grade is **`r read_success_m()`**,and the average difference between Q4 2015 and Q2 is **`r (reading_mean_m)`**. 
