...
Quetion:She develops positive relationships with her classmates.
...
pre_parent_tbl <- table(pre_parent_hr1) #test

dim(pre_parent_hr1) #test
...
post_parent_tbl_5 <- table(post_parent_hr1$Q5)

pander(post_parent_tbl_5)

post_parent_tbl_9 <- table(post_parent_hr1$Q9)
