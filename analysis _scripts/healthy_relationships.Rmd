...
The Cohen D test indicates that the impact is small. 
...
The number of pre parent surveys is **`r nrow(pre_parent)`**
...
The number of valid post parent survey is **`r nrow(post_parent)`**
...
The number of valid survey entries for the  post teacher survey is **`r nrow(post_teacher)`**

Question 7: She has developed positive relationships with her classmates

Question 10: The Get REAL! program helped her develop positive relationships with classmates.
