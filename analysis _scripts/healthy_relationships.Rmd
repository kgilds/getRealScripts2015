...
council <- group_by(hr_prepost2013, council)

council

gateway <-with(council,table(council,Post >=4.45))
...
fun_test_2014 <-with(hr_prepost2014,table(Post >=4.45))

fun_test_2014

fun_test_2014_i <-with(hr_prepost2014,table(Post <4.45 & hr.diff >0))
...
hr_all <- filter(hr_all, council == "Gateway Council")
...
```{r}
post <- group_by(hr_all, Year_Id, Post)
