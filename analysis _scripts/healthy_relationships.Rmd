...
plot(healthy_prepost$hr.diff >=4.45)
abline(h=0, col="red")
...
The Healthy Relationship questions measures the behaviors and attitudes of the respondent regarding their relationship skills. The number of valid survey entries is **`r nrow(pre_outcomes)`**.
