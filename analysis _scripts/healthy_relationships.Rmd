...
```{r test_tables, echo=FALSE, eval=FALSE}
...
hr_increase_df <- filter(hr_all, Post < 4.45)


hr_increase <-with(hr_increase_df, table(Year_Id, hr.diff > 0 ))

hr_increase

hr_increase <- prop.table(hr_increase,1)
...
The number and percent of students achieving the health relationship outcome at a high level or increased score is  **`r hr_sucess("M3")`**,and the percent of students achieving at a high level is **`r hr_achieved("M3")`**. The improvement in outcome scores is graphically represented below. 
