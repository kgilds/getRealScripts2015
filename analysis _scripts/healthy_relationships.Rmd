...
healthy_change_p + geom_count() + geom_hline(yintercept = 4.45, col="red")

healthy_change_p <- ggplot(healthy_change,(aes(x=hr.diff, y=council)))
healthy_change_p + geom_count()
