...
```{r}
pre_hr_histq <- qplot(healthy_prepost$Pre, geom="histogram", main= "Pre Survey", xlab="Outcome Scores", color="blue")

post_hr_histq <-qplot(healthy_prepost$Post, geom="histogram", main= "Post Survey", xlab="Outcome Scores", fill="blue")
