...
plot(pre_parent_hr1, type="heat") + ggtitle("Healthy Relationships")
...
plot(post_parent_hr1, type="heat") +ggtitle("Healthy Relationships")
...
colnames(post_teacher) [16] <- "Q1"
colnames(post_teacher) [19] <- "Q2"
...
post_teacher_tbl$Q1 <- factor(post_teacher$Q1, levels=c("Strongly Disagree", "Disagree", "Slightly Disagree", "Neither Agree/Disagree", "Slightly Agree", "Agree", "Strongly Agree"),ordered = TRUE)

post_teacher_tbl$Q2 <- factor(post_teacher$Q2, levels=c("Strongly Disagree", "Disagree", "Slightly Disagree", "Neither Agree/Disagree", "Slightly Agree", "Agree", "Strongly Agree"),ordered = TRUE)
...
plot(post_teacher_tbl, type="heat") + ggtitle("Healthy Relationships")
```
