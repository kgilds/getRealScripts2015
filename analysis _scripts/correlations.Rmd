...
outcomes_c <- select(outcomes, girlCode, hr.avg, ae.avg, am.avg)

outcomes_loghr <- log(outcomes$hr.avg)
...
skills_grades_read <- inner_join(outcomes_c, q1_reading, by = "girlCode")

dim(skills_grades_read)

head(skills_grades_read)


skills_grades_1 <-  select(skills_grades_read,hr.avg, ae.avg, am.avg, reading_pts)
...
plot(skills_grades_1$hr.avg~skills_grades_read$reading_pts)


skills_grades_lang <- inner_join(outcomes_c, q1_langarts, by = "girlCode")

skills_grades_2 <-  select(skills_grades_lang,hr.avg, ae.avg, am.avg, lang_pts)
...
hr_achieved <- filter(skills_grades_1, hr.avg >=4.45)

describe(hr_achieved$reading_pts)

hr_achieved_n <-filter(skills_grades_1, hr.avg < 4.45)

describe(hr_achieved_n$reading_pts)
