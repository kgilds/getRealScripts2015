...
susp_q2q4 <- inner_join(missing_q1q4, q4_suspensions, by="girlCode")
...
The number of the valid entries is **`r nrow(susp_2016)`**, and the percent of students who have decreased their suspensions or did not have any suspensions is **`r suspensions_success()`**. The average difference of suspensions between Quarter 1 and Quarter 2 is **`r susp_diff`**
