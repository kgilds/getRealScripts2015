...
###########################Read Data#############################################
rawdata <- read.csv("girl_survey_12202015.csv", skip=1)
dim(rawdata)
...
saveRDS(preDupes, file="duplicate_girl_survey_12202015.rds")
write.csv(preDupes, "pre_girl_dupes_12202015.csv", row.names=FALSE)
...
saveRDS(preUnique, file="girl_survey_12202015.RDS")
...
saveRDS(postUnique, file="girl_post_12202015.rds")
