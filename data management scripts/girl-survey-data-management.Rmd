...
setwd("C:/Users/kevin/Dropbox/GetReal/Data/2015-2016/February 2016")

library(dplyr)


###########################Read Data#############################################
rawdata <- read.csv("girlSurvey02202016.csv", skip=1)
dim(rawdata)
...
saveRDS(preUnique, file="girl_survey_02022016.rds")
