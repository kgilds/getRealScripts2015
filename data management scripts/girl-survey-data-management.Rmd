...
###########################Read Data#############################################
rawdata <- read.csv("girl_survey_11212015.csv", skip=1)
dim(rawdata)
...
saveRDS(preDupes, file="duplicate_girl_survey_11212015.rds")
...
saveRDS(preUnique, file="girl_survey_11212015.RDS")
...
saveRDS(postUnique, file="girl_post_11212015.rds")
