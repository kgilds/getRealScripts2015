...
###########################Read Data#############################################
rawdata <- read.csv("girlSurvey11072015.csv", skip=1)
dim(rawdata)
...
saveRDS(preDupes, file="duplicate_girl_survey_11072015.rds")
...
saveRDS(preUnique, file="girlSurvey110715.RDS")
...
saveRDS(postUnique, file="girl_post_11072015.rds")
