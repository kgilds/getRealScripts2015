...
###########################Read Data#############################################
rawdata <- read.csv("girl_survey_12132015.csv", skip=1)
dim(rawdata)
...
saveRDS(preDupes, file="duplicate_girl_survey_12132015.rds")
write.csv(preDupes, "pre_girl_dupes_12132015.csv", row.names=FALSE)
...
saveRDS(preUnique, file="girl_survey_12132015.RDS")
...
saveRDS(postUnique, file="girl_post_12132015.rds")
