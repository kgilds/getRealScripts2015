...
colnames (q2_grades) [60] <- "mjLangArts3Adv_quarter"
colnames (q2_grades) [61] <- "mjLangArts3Adv_semester"
...
q4_gradesUnique <- gradesq4 [!(duplicated(gradesq4$girlCode) | duplicated(gradesq2$girlCode, fromLast = TRUE)), ]
...
mq4Reading <- melt(q2Reading, id.vars=c("girlCode", "council"))
