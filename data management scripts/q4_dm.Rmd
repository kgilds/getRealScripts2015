...
q4free_readtst <- q4free_read[grep("read", q4free_read$reading_course, ignore.case = TRUE),]
...
grep("read", ignore.case=TRUE, q4free_read$reading_course)


q4free_read1 <-slice(q4free_read, 276)

q4free_read2 <-slice(q4free_read, 361)
...
q4free_read <- rbind(q4free_read1, q4free_read2)
...
southeast <- filter(mq4Reading, council =="Southeast Council")

southeast <- with(southeast,table(girlCode, readingGrade))
