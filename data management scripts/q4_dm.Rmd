...
na.omit(q4free_read$semester)


table(q4free_read$reading_course)

table(q4free_read$readFree1_quarter, q4free_read$reading_course)

table(q4free_read$readFree2_semester, q4free_read$reading_course)
...
q4Reading <- select(q4_gradesUnique, 7,8, 20:40)
...
mq4_read_1 <-cbind(mq4_read_1, reading_pts4) #bind data back in 
