...
############Read the data in R
teacher <- read.csv("teacherSurvey11072015.csv", skip=1)
...
saveRDS(pre_teacher_unique, file="pre_teacher_110715.rds")
...
saveRDS(postTeacherUnique, file="post_teacher_11072015.rds")
