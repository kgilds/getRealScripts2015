...
############Read the data in R
teacher <- read.csv("teacher_survey_12132015.csv", skip=1)
...
saveRDS(pre_teacher_unique, file="pre_teacher_12132015.rds")
...
saveRDS(postTeacherUnique, file="post_teacher_12132015.rds")
