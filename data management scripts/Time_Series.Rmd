...
pre_2014_hr <- describe(pre_survey_2014$hr.avg)
pre_2015_hr <- describe(pre_survey_2015$hr.avg)

kable(pre_2014_hr)


hr_2014 <- with(pre_survey_2014, table(hr.avg >=4.45))
...
```{r}
pre_2014_ae <-describe(pre_survey_2014$ae.avg)
pre_2015_ae <-describe(pre_survey_2015$ae.avg)

ae_pre <- with(pre_survey_2014, table(ae.avg >=4.5))
...
```{r}
pre_2014_am <- describe(pre_survey_2014$am.avg)
pre_2015_am <- describe(pre_survey_2015$am.avg) 

am_pre <-with(pre_survey_2014, table(am.avg >=4.8))
...
non_match <- anti_join(pre_survey_2015, post_survey_MY1415, by = "girlCode", Copy = FALSE)
...
hr_outcome_pre <- with(post_merge,table(hr.avg.y >=4.45))

pander(hr_outcome_pre)

hr_outcome_post <- with(post_merge,table(hr.avg.x >=4.45))

pander(hr_outcome_post)
