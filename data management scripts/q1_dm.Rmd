...
gradesUnique$council <-sub("Girl Scouts of Southeast Council", "Southeast Council", fixed=TRUE, gradesUnique$council)

gradesUnique$council <-sub("Girl Scouts of Tropical Florida", "Tropical Council", fixed = TRUE, gradesUnique$council)

gradesUnique$council <-sub("Girl Scouts of West Central Florida", "West Centeral Council", fixed = TRUE, gradesUnique$council)

gradesUnique$council <-sub("Girl Scouts of the Panhandle", "Panhandle Council", fixed = TRUE, gradesUnique$council)
...
saveRDS(gradesUnique, "grades_q1_12182015.rds")
...
saveRDS(mq1Reading, file = "reading_q1_12182015.rds")
...
saveRDS(mq1_lang, "langQ1_12182015.rds")
...
saveRDS(total_abs, "total_Absences_12182015.rds")
...
saveRDS(susp_total, "total_susp_12182015.rds")
...
saveRDS(expelled, "expelled_12182015.rds")

write.csv("expelled", file="expelled.csv", row.names = FALSE)
